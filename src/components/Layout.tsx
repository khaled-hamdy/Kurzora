            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:flex space-x-6 ml-8">
                  ...
                  <Link to="/how-it-works" className="text-slate-300 hover:text-white transition-colors">{t('nav.howItWorks')}</Link>
                  <Link to="/pricing" className="text-slate-300 hover:text-white transition-colors">{t('nav.pricing')}</Link>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center mr-2">
                  ...
                  <span className="text-xs text-green-400">{t('legal.shariahCompliant')}</span>
                </div>
                <LanguageToggle />
