        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
              {t('landing.title')}
              <span className="text-emerald-400">{t('landing.titleHighlight')}</span>
            </h1>
      ...
      <section id="features" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Why Traders Choose SwingTrader</h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              Professional-grade tools and insights for high-probability trading
            </p>
          </div>
          ...
          <div className="flex justify-center mt-12">
            <div className="flex items-center bg-green-500/10 backdrop-blur-sm border border-green-500/20 rounded-lg px-4 py-2 space-x-2">
              <Shield className="h-4 w-4 text-green-400" />
              <span className="text-green-400 text-sm font-medium">{t('legal.shariahCompliant')}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-emerald-600 to-blue-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-emerald-100 text-lg mb-8">
            Join thousands of traders already profiting with SwingTrader. Start your free trial today.
          </p>
          <Button 
            size="lg"
            onClick={() => setShowAuth('signup')}
          ...
          <div className="border-t border-slate-700 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <p className="text-center text-slate-400 text-sm">
                © 2024 SwingTrader. All rights reserved. Trading involves risk and may not be suitable for all investors.
              </p>
